                ...
                <div class="image-content">
                    ...
                    <div class="image">
                        <?php if (!empty($faq_content['faq_image'])): ?>
                            <img src="<?php echo esc_url($faq_content['faq_image']['url']); ?>"
                                alt="<?php echo esc_attr($faq_content['faq_image']['alt']); ?>">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="container gx-0">
        <div class="contact-box" style="background-image: url('<?php echo $newsletter_sec['news_bg_img']['url']; ?>');">
            ...
            <div class="form-sec">
                ...
                <button class="btn-black btn-hover"><?php echo $newsletter_sec['news_btn_text'] ?? 'Subscribe'; ?></button>
            </div>
        </div>
    </div>
</section>
